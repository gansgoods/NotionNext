const CONFIG = {
  ...
  SIMPLE_LOGO_DESCRIPTION: process.env.NEXT_PUBLIC_THEME_SIMPLE_LOGO_DESCRIPTION || '<div>Slasher Plus（即：斜杠中年）<br/>/独立开发者（未实现）<br/><br/>/独立翻唱者（未实现）<br/>/粤语精华普及者（不熟不普及）</div>', 
