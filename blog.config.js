...
const BLOG = {
  ...
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://notionfeb.gloong.tech/', // 网站地址
  ...
  CHATBASE_ID: process.env.NEXT_PUBLIC_CHATBASE_ID || 'Z6mMGFlvlhC4z8eIOE-No',
  ...
  ANALYTICS_GOOGLE_ID: process.env.NEXT_PUBLIC_ANALYTICS_GOOGLE_ID || 'G-1NQS3HHYJE', // 谷歌Analytics的id e.g: G-XXXXXXXXXX
